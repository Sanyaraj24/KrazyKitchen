...
import RecipeDisplay from "../../GenerativeAI/RecipeDisplay";

import CreateRecipes from "../../GenerativeAI/CreateRecipes";
...
function App() {
  ...
  return (
    <div className="bg-gray-100">
      ...
      <CreateRecipes onRecipeSubmit={handleRecipeSubmit} />
