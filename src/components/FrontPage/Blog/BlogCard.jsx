...
function BlogCard() {
  return (
    ...
    <section class="flex items-center py-16 bg-white lg:py-20 font-poppins dark:bg-gray-900 ">
        <div class="justify-center flex-1 max-w-3xl px-4 py-4 mx-auto text-left lg:py-10 ">
            ...
            <div
                ...
                <div class="px-4 py-4 lg:px-2 ">
                    <a href="#" class="text-sm font-medium text-gray-600 dark:text-gray-400 ">
                        June 4, 2022
                    </a>
                    <div class="w-8 pb-1 mb-4 border-b border-gray-600 dark:border-gray-400"></div>
          ...
          <div
                ...
                <div>
                    <a href="#" class="text-xs font-medium text-blue-600 dark:text-gray-400 ">
                        UI Design
                    </a>
                    <h2 class="mt-2 mb-4 text-xl font-semibold text-gray-600 dark:text-gray-300 ">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit</h2>
